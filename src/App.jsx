...
const dropdownData = [
  {
    ...
    heading: 'Words from Chairperson',
    ...
    para6: ``,
    para7 : 'Thanks and regards,',
    para8: ' Chandra Mani Rai',
    para9: ' Chairperson',
  },
  {
    path: '/our-company/managing-director',
    userImg : '/image/durgamanirai.jpg',
    heading: 'Words from Managing Director',
    para1:`Dear Clients & Employers `,
    ...
    para3: `We would like to bring it to our valued client's notice that Link Star Manpower Services Pvt. Ltd., with its competent staff member stands for quality services in order to meet required demands of the clients.`,
    para4: `We always consider the fact that the human potential should be utilized to the maximum extent for the betterment of the world. Hence, our priority is always to bridge up the opportunities and the human resources. In short, we undertake the responsibility to provide the right worker for the right job.`,
    para5: `We look forward to working with your esteemed organization in the days to come with mutual benefits.`,
    para6:`Assuring you of quality services.`,
    para7 : 'Thanks and regards,',
    para8 : `Durga Mani Rai`,
    para9: 'Managing Director',
  },
  {
    ...
    para7: '',
    para8: `Sanju B.K.`,
    para9: `Int'l Marketing Director`
  },
  // {
  //   path : '/our-company/managing-director',
  //   heading: 'Word from Managing Director',
  //   para1: `Dear Clients & Employers `,
  //   para2: `In present, there are hundreds of recruiting companies in Nepal, among which Link Star Manpower is found to be most specific and the reliable as its expert team, its collaboration, its formation, and as a whole, its vision to look after why foreign employment is so vital for today's generation.`,
  //   para3: `We aim to make the right assimilation of the two parties and have the progressive initiation for the betterment of an individual and company. Hovering to quarries and information may deprive the reality and lacks the reliability, so, Link Star Manpower goes so closely to every intuition and acts accordingly.`,
  ...
  //   para5:`Thank you for your business`,
  //   para6: ``,
  //   para7: `Thanks and regards,`,
  //   para8: `Durga Mani Rai`,
  //   para9: `Managing Director`,
  ...
  // },
 {
  ...
  para6: ``,
  para7: 'Thanks and regards,',
  para8: `Ratna Bahadur Adhikari`,
  para9: `Marketing Officer`
 },
 {
 ...
 },
 {
  ...
  para6: `Assuring you of quality services.`,
  para7: `Thanks and regards,`,
  para8 : `Harke Mani Rai`,
  para9: 'Executive Director'
 },
